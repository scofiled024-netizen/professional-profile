    ...
    cards: [
      {
        ...
        responsibility:
          "I served as the sole English-Chinese bilingual brand representative across the four-day exhibition, supporting sales, product communication, interpretation, and buyer engagement.",
        actions:
    ...
    entries: [
      {
        ...
        location: "Shanghai",
        summary:
          "Sole bilingual representative at HOTELEX Shanghai 2026, managing all client-facing operations for two international specialty coffee brands across a four-day trade expo. Delivered real-time English-Chinese interpretation for brand directors and closed 150+ transactions independently.",
      },
      {
        ...
        location: "Shanghai",
        summary:
          "Primary service contact between Manner Coffee and Lilith Games' corporate administration team across two campus locations. Managed daily client communication, event coordination, and operational records for a 300–400 person daily client base over nearly three years.",
      },
      {
