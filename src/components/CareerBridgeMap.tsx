...
const CONTENT = {
  ...
  zh: {
    title: "职业桥梁地图",
    subtitle: "从国际贸易到精品咖啡、客户体验，以及 AI 辅助的产品构建。",
    cards: [
      {
        id: "trade",
        icon: Globe,
        title: "国际贸易",
        short: "建立了跨境沟通、单证处理、供应商/客户协调与商务流程执行的基础。",
        expanded:
          "国际贸易背景让刘超具备跨境业务、英语沟通，以及多方利益相关者协调的实战经验，适合 B2B 服务、商务运营、海外客户对接与商业支持类岗位。",
        skills: ["跨境沟通", "供应商/客户协调", "单证与文档", "商务英语", "跟进与执行"],
      ...
      },
      {
        ...
        roles: ["客户体验专员", "品牌/零售运营", "面向客户的支持岗位", "社区或 hospitality 相关岗位"],
        skillsLabel: "技能",
        rolesLabel: "适合岗位",
      },
      {
      ...
      },
      {
        ...
        short: "使用 AI 工具构建实用个人产品，包括本网站与招聘方匹配报告。",
        expanded:
          "刘超正在学习用 AI 工具构建可运行的 Web 产品。本网站与招聘方匹配报告体现了好奇心、自学能力，以及将模糊想法落地为可用工具的能力。",
        skills: [
          "AI 辅助产品开发",
          "提示词工程",
          "网站迭代",
