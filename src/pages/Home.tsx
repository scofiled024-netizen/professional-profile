...
const CONTENT = {
  ...
  zh: {
    ...
    hero: {
      name: "刘超",
      title: "双语客户关系专业人士 · B2B销售与服务 · 中英无障碍沟通",
      subtitle: "B2B客户关系 · 双语销售 · 国际品牌服务",
      intro: "在亚洲最大的餐饮酒店展上，我一个人独立完成了150多笔销售；近三年服务300至400人规模的企业客户，全程英文处理海外B2B事务，不靠任何人兜底。语言、运营、人——我站在三者的交汇处。这才是真正意义上的桥梁工作。",
      button1: "查看精选项目",
      button2: "下载简历",
      linkedin: "https://www.linkedin.com/in/chaoliu-cn/",
      email: "scofiled024@gmail.com",
    ...
    work: {
      ...
      cards: [
        {
          num: "01",
          title: "代表国际咖啡品牌参展 HOTELEX 上海",
          tag: "HOTELEX 上海 2026 · Panda Bear Express",
          context: "Panda Bear Express 代表 ICOSA Brewhouse 与 Biru Roast 参展 HOTELEX 上海 2026——亚洲规模最大的餐饮酒店行业贸易展之一。",
          responsibility: "展会为期四天，我是全场唯一的中英双语品牌代表，独立承担销售、产品讲解、口译与买家接待的全部工作。",
          actions: "向中国贸易买家介绍产品价值；为国际品牌负责人及参赛咖啡师提供实时中英口译；独立处理买家咨询与异议，在客流高峰期全程不间断地维持销售节奏。",
          results: "四天内独立完成150多笔成交，实现外方团队与中国买家之间零沟通失误，在高密度、高压力的展会环境中始终保持稳定的服务状态。",
        ...
        },
        {
          ...
          responsibility: "作为5至25个活跃海外B2B客户的唯一英文联络人，全程独立管理订单生命周期。",
          actions: "响应询盘并准备报价。协调订单变更和生产更新。跟踪发货并及时通知客户。准备合同、发票和装箱单。处理售后问题、投诉及货款跟进。",
          results: "全程无需翻译协助，独立维护5至25个海外客户关系，零主要客诉升级。通过主动跟进订单进度，有效减少客户催单频率，维持长期稳定的合作关系。",
          skills: "订单管理 · 客户沟通 · 单证处理 · 国际贸易 · 利益相关方协调",
        },
        {
          num: "03",
          title: "驻场莉莉丝游戏总部 · 企业咖啡馆客户管理",
          tag: "Manner Coffee × 莉莉丝游戏 · 上海 · 2023年7月 – 2026年3月",
          context: "Manner Coffee 在莉莉丝游戏旗舰总部内运营一家专属咖啡馆——这座园区面积约两万平方米，曾多次荣获设计大奖，而咖啡馆是整个园区最核心的日常服务空间。",
          ...
          results: "近三年保持零重大服务失误，每日稳定服务300至400人规模的企业客户群。在高要求的甲方环境中，建立并维护了两家公司之间长期、可信赖的B2B服务合作关系。",
          skills: "企业客户管理 · 问题解决 · 活动协调 · 运营报告 · 长期客户关系",
        },
      ],
      labels: {
        context: "背景",
      ...
      entries: [
        {
          ...
          company: "Panda Bear Express（ICOSA Brewhouse & Biru Roast）",
          location: "上海",
          summary: "作为 HOTELEX 上海 2026 的唯一双语代表，全面负责两个国际精品咖啡品牌的所有客户对接工作。为品牌总监提供实时英中口译，独立完成150多笔交易。",
        },
        {
          date: "2023年7月 – 2026年3月",
          role: "高级咖啡师 & 企业客户联络负责人",
          company: "Manner Coffee × 莉莉丝游戏",
          location: "上海",
          summary: "担任 Manner Coffee 与莉莉丝游戏行政团队之间的主要服务联络人，横跨两个园区。近三年负责日常客户沟通、活动协调及300至400人规模客户群体的运营记录维护。",
        },
        {
          ...
          company: "JCBasic（上海听谛服饰辅料有限公司）",
          location: "上海",
          summary: "担任公司在阿里巴巴国际站、Amazon 及 Etsy 平台上5至25个海外B2B客户的唯一英语联络人，独立负责完整订单生命周期、商业单证及售后协调。",
        },
        {
          date: "2021年4月 – 7月",
          role: "运营与客户成功实习生",
    ...
    capabilities: {
      ...
      groups: [
        {
          name: "客户与利益相关方协调",
          desc: "在B2B、企业及展会等不同场景中建立并维护专业客户关系，管理客户期望，处理投诉，并在高压环境下确保沟通清晰无误。",
        },
        {
          name: "国际贸易与订单运营",
        ...
        {
          name: "双语与跨文化沟通",
          desc: "中英文流利，涵盖书面沟通、实时口译及跨文化客户管理。擅长在国际品牌团队与中文买家或合作伙伴之间搭建沟通桥梁。",
        },
        {
          name: "服务交付与问题解决",
    ...
    about: {
      title: "关于我",
      text: [
        "我的职业经历横跨国际贸易单证、精品咖啡、企业服务运营和现场展会销售。它们看起来分属不同行业——事实上也确是如此。但每份工作的核心都惊人地一致：理解对方需求，精准传达信息，并确保事情向前推进。",
        "我钟情于那些\"表达\"与\"理解\"之间的鸿沟真正起作用的角色。在这样的角色中，一封翻译不当的邮件会导致发货延迟；一次妥善处理的客户不满，能成为客户留下的理由；而成为房间里唯一的双语者，是一种机遇，而非负担。",
        "工作之余，我会仔细琢磨信息的传递方式——语气、精准度，以及那些被省略的内容。我相信，冷静而清晰的沟通，是一项值得认真对待的能力。",
      ],
    },
    education: {
      label: "教育背景",
    ...
    contact: {
      title: "联系方式",
      heading: "欢迎与我聊聊这个职位。",
      body: "目前正在寻找客户导向的B2B客户管理或客户成功类职位，优先考虑在华运营的国际品牌。常驻上海，可立即入职。",
      bodyExtra: "同样欢迎外贸跟单、国际业务协调等相关方向的机会。",
      email: "scofiled024@gmail.com",
      emailLabel: "邮箱",
      linkedin: "https://www.linkedin.com/in/chaoliu-cn/",
      linkedinLabel: "领英",
